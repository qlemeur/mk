<?php
class model_profile extends abstract_model{
	
	protected $sClassRow='row_profile';
	
	protected $sTable='profile';
	protected $sConfig='pdoMysql';
	
	protected $tId=array('pid');
	...
	public function findById($uId){
		return $this->findOne('SELECT * FROM '.$this->sTable.' WHERE pid=?',$uId );
	}
...
class row_profile extends abstract_row{
	
	protected $sClassModel='model_profile';

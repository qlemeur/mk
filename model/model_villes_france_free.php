<?php
class model_villes_france_free extends abstract_model{
	
	protected $sClassRow='row_villes_france_free';
	
	protected $sTable='villes_france_free';
	protected $sConfig='pdoMysql';
	
	protected $tId=array('ville_id');
	...
	public function findById($uId){
		return $this->findOne('SELECT * FROM '.$this->sTable.' WHERE ville_id=?',$uId );
	}
...
class row_villes_france_free extends abstract_row{
	
	protected $sClassModel='model_villes_france_free';

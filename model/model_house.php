<?php
class model_house extends abstract_model{
	
	protected $sClassRow='row_house';
	
	protected $sTable='house';
	protected $sConfig='pdoMysql';
	
	protected $tId=array('name');
...
class row_house extends abstract_row{
	
	protected $sClassModel='model_house';

<?php
class model_message extends abstract_model{
	
	protected $sClassRow='row_message';
	
	protected $sTable='message';
...
class row_message extends abstract_row{
	
	protected $sClassModel='model_message';

<?php
class model_interaction extends abstract_model{
	
	protected $sClassRow='row_interaction';
	
	protected $sTable='interaction';
	protected $sConfig='pdoMysql';
	
	protected $tId=array('id1');
	...
	public function findById($uId){
		return $this->findOne('SELECT * FROM '.$this->sTable.' WHERE id1=?',$uId );
	}
...
class row_interaction extends abstract_row{
	
	protected $sClassModel='model_interaction';

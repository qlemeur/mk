<?php
class model_ville_france_free extends abstract_model{
	
	protected $sClassRow='row_ville_france_free';
	
	protected $sTable='ville_france_free';
...
class row_ville_france_free extends abstract_row{
	
	protected $sClassModel='model_ville_france_free';
